      ...
      {showDetail && (
        <div className=" absolute top-0 left-0 z-10 grid w-full h-auto text-black bg-gray-100 md:grid-cols-2 gap-x-12 dark:text-white dark:bg-dark-100">
          ...
          <div>
            ...
            <div className="flex flex-wrap mt-5 space-x-2 text-sm tracking-wide">
              {key_techs.map((tech, i) => (
                <span
                  key={i}
                  className="px-1 py-2 my-1 bg-gray-200 rounded-sm rounded-lg dark:bg-dark-200 "
                >
                  {tech}
                </span>
              ))}
          ...
          <button
            ...
            className="absolute p-1 bg-gray-200 rounded-full top-3 right-3 focus:outline-none dark:bg-dark-100 dark:text-white"
          >
            <MdClose size={30} />
          </button>
        </div>
